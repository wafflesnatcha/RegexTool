...
RegexTool.Storage = (function() {
	return {
		get: function(key) {
			return $.Storage.get(RegexTool.config().storage_prefix + key);
		},

		set: function(key, value) {
			return $.Storage.set(RegexTool.config().storage_prefix + key, value);
		},

		remove: function(key) {
			return $.Storage.remove(RegexTool.config().storage_prefix + key);
		},
